            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Prueba</h1>
                    </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                               Fecha Prueba</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">2022-02-28</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Elaborado por </div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800" ><a href="https://hardwarestoreinvent.co/portafolio/"> Stiven Ortega</a></div>
                                        </div>
                                        <div class="col-auto">
